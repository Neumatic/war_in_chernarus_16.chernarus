...
*/
	...
	class controls {
		...
		class EquipButton : HW_RscButton {
			...
			text = "";
			onButtonClick = "removeBackpack bon_backpack_caller; bon_backpack_caller addWeapon (bon_getbackpack_backpacks select bon_getbackpack_index); closeDialog 0";		
		};
	};
};