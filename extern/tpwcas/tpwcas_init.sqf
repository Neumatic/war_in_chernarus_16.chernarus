...
tpwcas_running = true;
	...
	call compile preprocessFileLineNumbers "extern\tpwcas\tpwcas_debug.sqf"; //visual debugging

	//if ( tpwcas_mode <= 2 ) then  // not used for server only or Headless client mode
	//{
		call compile preprocessFileLineNumbers "extern\tpwcas\tpwcas_client_debug.sqf"; //visual debugging
		//call compile preprocessFileLineNumbers "extern\tpwcas\tpwcas_textdebug.sqf"; //text debugging => DEPRECATED
		call compile preprocessFileLineNumbers "extern\tpwcas\tpwcas_visuals.sqf"; //player suppression visuals
	//};

	call compile preprocessFileLineNumbers "extern\tpwcas\tpwcas_decskill.sqf"; //decrease AI skills
	call compile preprocessFileLineNumbers "extern\tpwcas\tpwcas_incskill.sqf"; //increase AI skills
	call compile preprocessFileLineNumbers "extern\tpwcas\tpwcas_supstate.sqf"; //bdetect callback to assign unit suppression status
	call compile preprocessFileLineNumbers "extern\tpwcas\tpwcas_getcover.sqf"; //move suppressed unit into cover
	call compile preprocessFileLineNumbers "extern\tpwcas\tpwcas_runforit.sqf"; //civilians will run away from the shooting

	call compile preprocessFileLineNumbers "extern\tpwcas\tpwcas_mainloop.sqf"; //main loop

	//////////////
	//CALL BDETECT
	//////////////

	call compile preprocessFileLineNumbers "extern\tpwcas\tpwcas_bdetect.sqf"; //bullet detection
	...
	bdetect_debug_levels = [0,3,5,6,7,8,9,10,11];
	...
	{
		call compile preprocessFileLineNumbers "extern\tpwcas\tpwcas_los.sqf"; //tpw los main loop

		// Run day/night determination
		[] execVm "extern\tpwcas\tpwcas_los_sunangle.sqf"; //determine day or night
		if ( tpwcas_debug > 0 ) then
		{
			diag_log format ["%1 - TPWCAS LOS Sun angle detection started", time];
		};
		...
		if ( tpwcas_debug > 0 ) then
		{
			diag_log format ["%1 - TPWCAS LOS started", time];
		};
	};
	...
	if ( tpwcas_debug > 0 ) then
	{
		diag_log format ["%1 - TPWCAS mainloop started", time];
	};
	...
	if ( (tpwcas_debug > 0) && ( isServer || (tpwcas_mode == 2 ) || tpwcas_isHC ) ) then
	{
		...
		diag_log format ["%1 - TPWCAS Debug started", time];
	};
