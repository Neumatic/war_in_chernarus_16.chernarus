...
if (isServer) then
{
	...
	*/
	...
	_filet = createVehicle [format ["Land_CamoNet_NATO%1", _suffixe_arrowhead], _temp_pos, [], 0, "NONE"];
	...
	_caisse_mun = createVehicle [format ["USVehicleBox%1", _suffixe_arrowhead], _temp_pos, [], 0, "NONE"];
	...
	_pancarte = createVehicle [format ["Notice_board%1", _suffixe_arrowhead], _temp_pos, [], 0, "NONE"];
	...
	_chaise = createVehicle ["FoldChair", _temp_pos, [], 0, "NONE"];
