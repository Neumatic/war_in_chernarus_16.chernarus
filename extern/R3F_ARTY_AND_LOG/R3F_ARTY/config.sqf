...
{
	R3F_ARTY_CFG_pieces_artillerie = R3F_ARTY_CFG_pieces_artillerie + ["M1129_MC_EP1","MLRS", "GRAD_Base"]; //added mlrs and grad-normally disabled beacuse of ace.. but why?
...
if (isClass (configFile >> "CfgVehicles" >> "BAF_Soldier_MTP")) then
{
	R3F_ARTY_CFG_calculateur_interne = R3F_ARTY_CFG_calculateur_interne + ["M1129_MC_EP1", "MLRS", "GRAD_Base"];
	// ACE currently don't work (ACE_ARTY_ReplaceWithAmmo)
	if !(isClass (configFile >> "CfgVehicles" >> "ACE_Help")) then
	{
 ...
 */
R3F_ARTY_CFG_calculateur_externe = ["ACE_P159_RD54_crate", "ACE_P159_RD90_crate", "ACE_P159_RD99_crate", "ACE_P168_RD90_crate"];
