...
class R3F_REV_dlg_attente_reanimation
{
	...
	onKeyDown = "if (_this select 1 == 1) then {objNull spawn {sleep 2; if (damage player > 0.7 && {isNull (findDisplay 89453)}) then {createDialog ""R3F_REV_dlg_attente_reanimation""};};}; false";
