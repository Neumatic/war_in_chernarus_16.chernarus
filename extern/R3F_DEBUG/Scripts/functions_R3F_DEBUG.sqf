...
call compile preprocessFileLineNumbers "extern\R3F_DEBUG\Scripts\FNCT_R3F_DEBUG_DoTeleport.sqf";
call compile preprocessFileLineNumbers "extern\R3F_DEBUG\Scripts\FNCT_R3F_DEBUG_KillThemAll.sqf";
call compile preprocessFileLineNumbers "extern\R3F_DEBUG\Scripts\FNCT_R3F_DEBUG_MakeVehicle.sqf";
call compile preprocessFileLineNumbers "extern\R3F_DEBUG\Scripts\FNCT_R3F_DEBUG_DoCamera.sqf";
call compile preprocessFileLineNumbers "extern\R3F_DEBUG\Scripts\FNCT_R3F_DEBUG_SetTeleportation.sqf";
call compile preprocessFileLineNumbers "extern\R3F_DEBUG\Scripts\FNCT_R3F_DEBUG_SetInvulnerability.sqf";
call compile preprocessFileLineNumbers "extern\R3F_DEBUG\Scripts\FNCT_R3F_DEBUG_SetVelocity.sqf";
call compile preprocessFileLineNumbers "extern\R3F_DEBUG\Scripts\FNCT_R3F_DEBUG_InfiniteAmmo.sqf";
call compile preprocessFileLineNumbers "extern\R3F_DEBUG\Scripts\FNCT_R3F_DEBUG_GetNormalizedSpeedInterp.sqf";
call compile preprocessFileLineNumbers "extern\R3F_DEBUG\Scripts\FNCT_R3F_DEBUG_SetNeutrality.sqf";
call compile preprocessFileLineNumbers "extern\R3F_DEBUG\Scripts\FNCT_R3F_DEBUG_InactiveIA.sqf";
call compile preprocessFileLineNumbers "extern\R3F_DEBUG\Scripts\FNCT_R3F_DEBUG_GodSight.sqf";
call compile preprocessFileLineNumbers "extern\R3F_DEBUG\Scripts\FNCT_R3F_DEBUG_SetSkill.sqf";
call compile preprocessFileLineNumbers "extern\R3F_DEBUG\Scripts\FNCT_R3F_DEBUG_Diag_Log.sqf";
call compile preprocessFileLineNumbers "extern\R3F_DEBUG\Scripts\FNCT_R3F_DEBUG_SetShowIA.sqf";
call compile preprocessFileLineNumbers "extern\R3F_DEBUG\Scripts\FNCT_R3F_DEBUG_ShowMap.sqf";
call compile preprocessFileLineNumbers "extern\R3F_DEBUG\Scripts\FNCT_R3F_DEBUG_ShowDlgScript.sqf";
call compile preprocessFileLineNumbers "extern\R3F_DEBUG\Scripts\FNCT_R3F_DEBUG_ShowDlgSpy.sqf";
call compile preprocessFileLineNumbers "extern\R3F_DEBUG\Scripts\FNCT_R3F_DEBUG_Spy.sqf";
call compile preprocessFileLineNumbers "extern\R3F_DEBUG\Scripts\FNCT_R3F_DEBUG_Interface.sqf";

disableSerialization;

FNCT_R3F_DEBUG_ReCoord = {
	private ["_main_dialog", "_control"];
...
FNCT_R3F_DEBUG_UpdateDisplay = {
	...
	private ["_optionIndex", "_optionValueIndices", "_valueChangedEffect", "_main_dialog", "_option", "_optionValue", "_optionValueIndex"];
		...
		for [{_i = 0}, {_i < CONST_R3F_DEBUG_OPTION_COUNT}, {_i = _i + 1}] do {
			...
			if (_i == _optionIndex) then {
				...
				if (_valueChangedEffect) then {
					if !(scriptDone VAR_R3F_DEBUG_UpdateDisplayColorizeValueChangedHandle) then {
...
FNCT_R3F_DEBUG_KeyDown = {
	private ["_ctrl", "_dikCode", "_shift", "_alt", "_handled", "_optionValueIndex", "_propertyValueChanged", "_maxValueCount"];
	...
	if (_dikCode == DIK_LEFT && VAR_R3F_DEBUG_ShowDlg) then {
		...
		if (_optionValueIndex > 0 || _maxValueCount == 1) then {
		...
		if (_dikCode == DIK_RIGHT && VAR_R3F_DEBUG_ShowDlg) then {
			...
			if ((_optionValueIndex < (_maxValueCount - 1)) || _maxValueCount == 1) then {
				_propertyValueChanged = true;
			};
...
FNCT_R3F_DEBUG_launch = {
	...
	private ["_display_commandpanel_main", "_idx_keydown_eh"];
