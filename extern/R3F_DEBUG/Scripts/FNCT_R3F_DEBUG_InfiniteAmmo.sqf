...
FNCT_R3F_DEBUG_InfiniteAmmo = {
	...
	if (VAR_R3F_DEBUG_InfiniteAmmoState && (VAR_R3F_DEBUG_EH_InfAmmo == -1)) then {
		...
		VAR_R3F_DEBUG_magazine = currentMagazine player;
		VAR_R3F_DEBUG_mag = configName (configFile >> "CfgMagazines" >> VAR_R3F_DEBUG_magazine);
		VAR_R3F_DEBUG_bullet = getNumber (configFile >> "CfgMagazines" >> VAR_R3F_DEBUG_magazine >> "count");
