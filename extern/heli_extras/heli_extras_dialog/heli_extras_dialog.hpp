...
class FDKTZ_Heli_Extras_Menu_Dialog
{
	...
	onLoad = "execVM 'extern\heli_extras\get_helis_in_squad.sqf'";
	controlsBackground[] =
	{
	...
	{
		text = "Designate LZ";
		action = "execVM 'extern\heli_extras\helicopter\create_LZ_heli.sqf';";
		w = 0.22;
		x = 0.1;
		y = 0.155;
	};
	...
	{
		text = "Delete LZ";
		action = "execVM 'extern\heli_extras\helicopter\delete_LZ_heli.sqf';";
		w = 0.20;
		x = 0.35;
		y = 0.155;
	};
	...
	class FDKTZ_Heli_Extras_Menu_Select_Heli: FDKTZ_Heli_Extras_Menu_Combo_Box
	{
		...
		onLBSelChanged = "execVM 'extern\heli_extras\heli_type.sqf'";
	};
	...
	class FDKTZ_Heli_Extras_Menu_Start_Engine: FDKTZ_Heli_Extras_Menu_Button
	{
		...
		text = "Start Engine";
		action = "execVM 'extern\heli_extras\helicopter\heli_scripts\heli_options\heli_start_engine.sqf'";
		x = 0.1;
		y = 0.25;
		w = 0.25;
	};
	...
	class FDKTZ_Heli_Extras_Menu_Dust_Off: FDKTZ_Heli_Extras_Menu_Button
	{
		...
		text = "Dust Off";
		action = "execVM 'extern\heli_extras\helicopter\heli_scripts\heli_options\heli_dust_off.sqf'";
		x = 0.1;
		y = 0.3;
		w = 0.2;
	};
	...
	class FDKTZ_Heli_Extras_Menu_Land: FDKTZ_Heli_Extras_Menu_Button
	{
		...
		text = "Land";
		action = "execVM 'extern\heli_extras\helicopter\heli_scripts\heli_options\heli_land.sqf'";
		x = 0.1;
		y = 0.4;
		w = 0.2;
	};
	...
	class FDKTZ_Heli_Extras_Menu_Combat_Landing: FDKTZ_Heli_Extras_Menu_Button
	{
		...
		action = "execVM 'extern\heli_extras\helicopter\heli_scripts\heli_options\heli_getout.sqf'";
		x = 0.1;
		y = 0.45;
		w = 0.26;
	};
	...
	class FDKTZ_Heli_Extras_Menu_Combat_Pickup: FDKTZ_Heli_Extras_Menu_Button
	{
		...
		text = "Combat Pickup";
		action = "execVM 'extern\heli_extras\helicopter\heli_scripts\heli_options\heli_getin.sqf'";
		x = 0.1;
		y = 0.50;
		w = 0.26;
	};
	...
	class FDKTZ_Heli_Extras_Menu_Abort_Landing: FDKTZ_Heli_Extras_Menu_Button
	{
		...
		text = "Abort Landing";
		action = "execVM 'extern\heli_extras\helicopter\heli_scripts\heli_options\heli_abort_landing.sqf'";
		x = 0.1;
		y = 0.55;
		w = 0.25;
	};
	...
	class FDKTZ_Heli_Extras_Menu_AI_Fastrope: FDKTZ_Heli_Extras_Menu_Button
	{
		...
		text = "Fastrope (AI)";
		action = "execVM 'extern\heli_extras\helicopter\heli_scripts\heli_options\heli_ai_fastrope.sqf'";
		x = 0.1;
		y = 0.63;
		w = 0.25;
	};
	...
	class FDKTZ_Heli_Extras_Menu_AI_Slingload: FDKTZ_Heli_Extras_Menu_Button
	{
		...
		action = "execVM 'extern\heli_extras\helicopter\heli_scripts\heli_options\heli_AI_attach_cargo.sqf'";
		x = 0.1;
		y = 0.68;
		w = 0.25;
	};
	...
	class FDKTZ_Heli_Extras_Menu_AI_Slingload_Detach: FDKTZ_Heli_Extras_Menu_Button
	{
		...
		action = "execVM 'extern\heli_extras\helicopter\heli_scripts\heli_options\heli_AI_detach_cargo.sqf'";
		x = 0.1;
		y = 0.73;
		w = 0.25;
	};
	...
	class FDKTZ_Heli_Extras_Menu_Circle_Left_Button: FDKTZ_Heli_Extras_Menu_Button
	{
		idc = -1;
		text = "Left";
		action = "['left'] execVM 'extern\heli_extras\helicopter\heli_scripts\circle_pos\circle_area_init.sqf'";
		x = 0.76;
		y = 0.6;
		w = 0.15;
	};
	...
	class FDKTZ_Heli_Extras_Menu_Circle_Right_Button: FDKTZ_Heli_Extras_Menu_Button
	{
		idc = -1;
		text = "Right";
		action = "['right'] execVM 'extern\heli_extras\helicopter\heli_scripts\circle_pos\circle_area_init.sqf'";
		x = 0.91;
		y = 0.6;
		w = 0.15;
	};
