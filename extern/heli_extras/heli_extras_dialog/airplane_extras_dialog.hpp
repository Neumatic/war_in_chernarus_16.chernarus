...
class FDKTZ_Airplane_Extras_Menu_Dialog
{
	...
	onLoad = "execVM 'extern\heli_extras\get_airplanes_in_squad.sqf'";
	controlsBackground[] =
	{
	...
	class FDKTZ_Airplane_Extras_Menu_Select_Airplane: FDKTZ_Airplane_Extras_Menu_Combo_Box
	{
		...
		//onLBSelChanged = "execVM 'extern\heli_extras\airplane_type.sqf'";
	};
	...
	class FDKTZ_Airplane_Extras_Menu_Land: FDKTZ_Airplane_Extras_Menu_Button
	{
		idc = -1; //Change Later
		text = "Land";
		action = "execVM 'extern\heli_extras\airplane\airplane_land.sqf'";
		x = 0.1;
		y = 0.25;
		w = 0.2;
	};
	...
	class FDKTZ_Airplane_Extras_Menu_Height_150_Button: FDKTZ_Airplane_Extras_Menu_Button
	{
		...
		text = "150 Meters";
		action = "execVM 'extern\heli_extras\airplane\airplane_flyheight_150.sqf'";
		x = 0.37;
		y = 0.25;
		w = 0.2;
	};
	...
	class FDKTZ_Airplane_Extras_Menu_Height_500_Button: FDKTZ_Airplane_Extras_Menu_Button
	{
		...
		text = "500 Meters";
		action = "execVM 'extern\heli_extras\airplane\airplane_flyheight_500.sqf'";
		x = 0.37;
		y = 0.30;
		w = 0.2;
	};
	...
	class FDKTZ_Airplane_Extras_Menu_Height_1000_Button: FDKTZ_Airplane_Extras_Menu_Button
	{
		...
		text = "1000 Meters";
		action = "execVM 'extern\heli_extras\airplane\airplane_flyheight_1000.sqf'";
		x = 0.57;
		y = 0.25;
		w = 0.2;
	};
	...
	class FDKTZ_Heli_Extras_Menu_Height_100: FDKTZ_Airplane_Extras_Menu_Button
	{
		...
		text = "100 Meters";
		action = "execVM 'extern\heli_extras\helicopter\heli_scripts\heli_options\heli_flyheight_100.sqf'";
		x = 0.57;
		y = 0.30;
		w = 0.2;
	};
	*/
	...
	class FDKTZ_Airplane_Extras_Menu_Paradrop_Button: FDKTZ_Airplane_Extras_Menu_Button
	{
		...
		text = "Paradrop";
		action = "execVM 'extern\heli_extras\airplane\airplane_paradrop.sqf';";
		x = 0.1;
		y = 0.4;
		w = 0.2;
	};
	...
	class FDKTZ_Airplane_Extras_Menu_HALO_Button: FDKTZ_Airplane_Extras_Menu_Button
	{
		...
		text = "HALO";
		action = "execVM 'extern\heli_extras\airplane\airplane_halo.sqf';";
		x = 0.1;
		y = 0.45;
		w = 0.2;
	};
